import {tPointGrid, tPolarPointer,tShiftGrid, iMortar_, iTarget_, iGeoLocationElement} from "./basicTypes";
...
export function calcMortarFireDataPolar(mortar:iMortar_,target:iTarget_,fo:iGeoLocationElement){
  var mortarPosition:tPointGrid = {east:mortar.location.east, north:mortar.location.north};
...
export function calcMortarFireDataShiftPolar(mortar:iMortar_,target:iTarget_,fo:iGeoLocationElement){
...
export function offSetShiftPolar(target:iTarget_,fo:iGeoLocationElement){
