import {iMortar_, iTarget_, iLocationInput_, iGeoLocationElement} from "./basicTypes";
...
class Location implements iLocationInput_{  
  private _htmlElem:HTMLElement = document.createElement("div");
  ...
  constructor(previousElem?:iLocationInput_){
...
abstract class GeoLocationElement implements iGeoLocationElement{
  location:iLocationInput_;
  protected _htmlElem:HTMLElement = document.createElement("div");
  No: number;
  DisplayTitle: string;
  
  constructor(prevLoc?:iGeoLocationElement,ObjectType?:string){
...
export class Mortar extends GeoLocationElement implements iMortar_{
...
export class Target extends GeoLocationElement implements iTarget_ {
  ...
  frontObserver? : iGeoLocationElement;
