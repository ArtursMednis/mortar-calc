import { mortarTargetBipartiteGraph, Mortar, Target, FO, iMortarTargetBipartiteGraph} from "./createDomElements";
import { Map } from "./createMap";
import { iMortar_, iTarget_, iGeoLocationElement } from "./basicTypes";
...
class FireMission{
  mortars: iMortar_[] = [];
  targets: iTarget_[] = [];
  frontObserver: iGeoLocationElement = new FO();
